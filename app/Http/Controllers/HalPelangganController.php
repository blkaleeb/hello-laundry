...
class HalPelangganController extends Controller
{
    ...
    public function halamanTransaksi()
    {
        $transaksis = Transaksi::join('pelanggans', 'pelanggans.kd_pelanggan', '=', 'transaksis.kd_pelanggan')
            ...
            ->select('transaksis.*', 'pelanggans.nama_pelanggan', 'pelanggans.cek_member', 'pelanggans.id as id_pelanggan', 'outlets.nama as nama_outlet')
            ->get();
    ...
    public function simpanPelanggan(Request $req)
    {
        ...
        if ($cek_username == 1) {
            ...
            if ($req->cek_member == 1) {
                ...
                $pelanggans->password = $max_code_pelanggan;
            }
            $pelanggans->save();
            ...
            if ($req->cek_member == 1) {
                ...
                $penggunas->username = $max_code_pelanggan;
            }
