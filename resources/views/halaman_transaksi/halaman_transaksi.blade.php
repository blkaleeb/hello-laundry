...
@section('css')
    ...
    <style type="text/css">
        ...
        .table-total tr th,
        .table-total tr td,
        .table-pembayaran tr th,
        .table-pembayaran tr td {
            padding: 3px;
        }
...
@section('konten')
    ...
    <div class="container-fluid">
        <div class="row">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="default-tab">
                                            <ul class="nav nav-tabs mb-3">
                                                <li class="nav-item"><a href="#identitas-tab-diambil"
                                                        class="nav-link identitas-btn-diambil active" data-toggle="tab"
                                                        aria-expanded="false">Identitas</a>
                                                </li>
                                                <li class="nav-item"><a href="#paket-tab-diambil"
                                                        class="nav-link paket-btn-diambil" data-toggle="tab"
                                                        aria-expanded="false">Paket</a>
                                                </li>
                                                <li class="nav-item"><a href="#pembayaran-tab-diambil"
                                                        class="nav-link pembayaran-btn-diambil" data-toggle="tab"
                                                        aria-expanded="true">Pembayaran</a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                <table
                                                                    class="table header-border table_paket table_kiloan_ambil"
                                                                    width="100">
                                                                    <thead>
                                                                        <tr>
                                                                            <th scope="col">No</th>
                                                                ...
                                                                <table
                                                                    class="table header-border table_paket table_satuan_ambil"
                                                                    width="100" hidden="">
                                                        ...
                                                        <div class="col-md-6 offset-md-6">
                                                            <table style="width: 100%;" class="table-total">
                                                                ...
                                                                <tr>
                                                                    <th>Total Paket</th>
                                                                    <td class="modal_ambil_total_paket font-weight-bold">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item d-flex justify-content-between align-items-center"
                                                                    id="modal_ambil_subtotal_paket"></li>
                                                                <li class="list-group-item d-flex justify-content-between align-items-center"
                                                                    id="modal_ambil_biaya_antar"></li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-md-12 line-pembayaran-diambil"
                                                            style="margin-top: -15px;">
                                                            <hr>
                                                        </div>
                                                        <div class="col-md-6 offset-md-6">
                                                            <table style="width: 100%;"
                                                                class="table-pembayaran text-left">
                                                                <tr>
                                                                    <td>Subtotal</td>
                                                                ...
                                                                <tr>
                                                                    <th>Bayar</th>
                                                                    <th class="text-success text-right modal_ambil_bayar">
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2" class="line-pembayaran"></td>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <button type="button"
                                            class="btn btn-primary btn-block btn-flat font-weight-bold pdf-btn"><i
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="default-tab">
                                            <ul class="nav nav-tabs mb-3">
                                                <li class="nav-item"><a href="#identitas-tab-diantar"
                                                        class="nav-link identitas-btn-diantar active" data-toggle="tab"
                                                        aria-expanded="false">Identitas</a>
                                                </li>
                                                <li class="nav-item"><a href="#paket-tab-diantar"
                                                        class="nav-link paket-btn-diantar" data-toggle="tab"
                                                        aria-expanded="false">Paket</a>
                                                </li>
                                                <li class="nav-item"><a href="#pembayaran-tab-diantar"
                                                        class="nav-link pembayaran-btn-diantar" data-toggle="tab"
                                                        aria-expanded="true">Pembayaran</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content br-n pn">
                                                <div id="identitas-tab-diantar" class="tab-pane active">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 text-center">
                                                            <img src="{{ asset('gif/scooter-running.gif') }}"
                                                                class="gif-antar">
                                                        </div>
                                                ...
                                                <div id="paket-tab-diantar" class="tab-pane">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                <table
                                                                    class="table header-border table_paket table_kiloan_antar"
                                                                    width="100">
                                                                    <thead>
                                                                        <tr>
                                                                            <th scope="col">No</th>
                                                                ...
                                                                <table
                                                                    class="table header-border table_paket table_satuan_antar"
                                                                    width="100" hidden="">
                                                                    <thead class="text-center">
                                                                        <tr>
                                                                            <th scope="col">No</th>
                                                        ...
                                                        <div class="col-md-6 offset-md-6">
                                                            <table style="width: 100%;" class="table-total">
                                                                ...
                                                                <tr>
                                                                    <th>Total Paket</th>
                                                                    <td class="modal_antar_total_paket font-weight-bold">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                ...
                                                <div id="pembayaran-tab-diantar" class="tab-pane">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item d-flex justify-content-between align-items-center"
                                                                    id="modal_antar_subtotal_paket"></li>
                                                                <li class="list-group-item d-flex justify-content-between align-items-center"
                                                                    id="modal_antar_biaya_antar"></li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-md-12 line-pembayaran-diantar"
                                                            style="margin-top: -15px;">
                                                            <hr>
                                                        </div>
                                                        <div class="col-md-6 offset-md-6">
                                                            <table style="width: 100%;"
                                                                ...
                                                                <tr>
                                                                    <th>Bayar</th>
                                                                    <th class="text-success text-right modal_antar_bayar">
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2" class="line-pembayaran"></td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table header-border table_paket table_satuan" width="100"
                                                hidden="">
                                                <thead class="text-center">
                                                    <tr>
                                                        <th scope="col">No</th>
                                    ...
                                    <div class="col-md-12">
                                        <form class="bayar_form" method="POST">
                                            ...
                                            <div class="row" hidden="">
                                                <div class="col-md-12">
                                                    <input type="text" name="id_transaksi_input"
                                                        class="id_transaksi_input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly" name="sub_total_bayar"
                                                            class="form-control sub_total_bayar">
                                                        <input type="text" readonly="readonly"
                                                            name="sub_total_bayar_2"
                                                            class="form-control sub_total_bayar_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="number" min="0" max="100"
                                                            name="diskon_bayar" class="form-control diskon_bayar">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="number" min="0" max="100"
                                                            name="pajak_bayar" class="form-control pajak_bayar">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly" name="total_bayar"
                                                            class="form-control total_bayar">
                                                        <input type="text" readonly="readonly" name="total_bayar_2"
                                                            class="form-control total_bayar_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="bayar_bayar"
                                                            class="form-control bayar_bayar number_input">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly" name="kembali_bayar"
                                                            class="form-control kembali_bayar">
                                                        <input type="text" readonly="readonly" name="kembali_bayar_2"
                                                            class="form-control kembali_bayar_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <button class="btn btn-primary btn-block bayar_btn font-weight-bold"
                                                type="button">Bayar</button>
                                            <button class="btn btn-primary btn-block diantar_btn font-weight-bold"
                                                type="button" hidden="">Antar Barang</button>
                                            <button class="btn btn-primary btn-block diambil_btn font-weight-bold"
                                                type="button" hidden="">Barang Diambil</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12">
                <div class="modal fade" id="lihatTransaksiProses">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Keterangan</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: -10px;">
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-flat btn-primary" id="all-btn">Semua</button>
                            <button class="btn btn-flat btn-outline-primary ml-2" id="baru-btn">Baru</button>
                            <button class="btn btn-flat btn-outline-primary ml-2" id="proses-btn">Proses</button>
        ...
        <div class="row" style="margin-top: -15px;">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive" id="member_table">
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'member')
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="label label-pill label-info">{{ $transaksi->status }}</span>
                                                </td>
                                                <td style="font-size: 16px;" class="text-center">
                                                    <a href="{{ url('detail_pelanggan_member', $transaksi->id_pelanggan) }}"
                        ...
                        <div class="table-responsive" id="member_table_baru" hidden="">
                            <table class="table table-striped table-bordered zero-configuration">
                                <thead style="text-align: center;">
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                    <?php $number1 = 1; ?>
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'member' && $transaksi->status == 'baru')
                                            <tr>
                                                <th class="align-middle text-center">{{ $number1 }}</th>
                                                <th>{{ $transaksi->nama_outlet }}</th>
                                                <td>{{ $transaksi->kd_invoice }}</td>
                        ...
                        <div class="table-responsive" id="member_table_proses" hidden="">
                            <table class="table table-striped table-bordered zero-configuration">
                                <thead style="text-align: center;">
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                    <?php $number1 = 1; ?>
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'member' && $transaksi->status == 'proses')
                                            <tr>
                                                <th class="align-middle text-center">{{ $number1 }}</th>
                                                <th>{{ $transaksi->nama_outlet }}</th>
                                                <td>{{ $transaksi->kd_invoice }}</td>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="label label-pill label-warning">{{ $transaksi->status }}</span>
                                                </td>
                                                <td style="font-size: 16px;" class="text-center">
                                                    <a href="{{ url('detail_pelanggan_member', $transaksi->id_pelanggan) }}"
                                                        class="btn btn-sm btn-primary font-weight-bold">Lihat</a>
                        ...
                        <div class="table-responsive" id="member_table_selesai" hidden="">
                            <table class="table table-striped table-bordered zero-configuration">
                                <thead style="text-align: center;">
                                    <tr>
                                        <th>No</th>
                                    ...
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'member' && $transaksi->status == 'selesai')
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="label label-pill label-success">{{ $transaksi->status }}</span>
                                                </td>
                                                <td style="font-size: 16px;" class="text-center">
                                                    <button data-toggle="modal" data-target="#lihatTransaksiSelesai"
                                                        data-lihat="{{ $transaksi->id }}"
                                                        class="btn btn-sm btn-primary font-weight-bold lihat_selesai">Lihat</button>
                                                </td>
                                            </tr>
                                            <?php $number1++; ?>
                                        @endif
                                    ...
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'member' && $transaksi->status == 'diantar')
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="label label-pill label-danger">{{ $transaksi->status }}</span>
                                                </td>
                                                <td style="font-size: 16px;" class="text-center">
                                                    <button data-toggle="modal" data-target="#lihatTransaksiDiantar"
                                                        data-lihat="{{ $transaksi->id }}"
                                                        class="btn btn-sm btn-primary font-weight-bold lihat_diantar">Lihat</button>
                                                </td>
                                            </tr>
                                            <?php $number2++; ?>
                                        @endif
                                    ...
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'member' && $transaksi->status == 'diambil')
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="label label-pill label-primary">{{ $transaksi->status }}</span>
                                                </td>
                                                <td style="font-size: 16px;" class="text-center">
                                                    <button data-toggle="modal" data-target="#lihatTransaksiDiambil"
                                                        data-lihat="{{ $transaksi->id }}"
                                                        class="btn btn-sm btn-primary font-weight-bold lihat_diambil">Lihat</button>
                                                </td>
                                            </tr>
                                            <?php $number3++; ?>
                                        @endif
                        ...
                        <div class="table-responsive" id="non_member_table" hidden="">
                            <table class="table table-striped table-bordered zero-configuration">
                                <thead style="text-align: center;">
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                    <?php $number4 = 1; ?>
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'non_member')
                                            <tr>
                                                ...
                                                <td style="font-size: 16px;" class="text-center">
                                                    <a href="{{ url('detail_pelanggan_non_member', $transaksi->id_pelanggan) }}"
                                                        target="_blank"
                                                        class="btn btn-sm btn-primary font-weight-bold">Lihat</a>
                                                </td>
                                            </tr>
                        ...
                        <div class="table-responsive" id="non_member_table_baru" hidden="">
                            <table class="table table-striped table-bordered zero-configuration">
                                <thead style="text-align: center;">
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                    <?php $number4 = 1; ?>
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'non_member' && $transaksi->status == 'baru')
                                            <tr>
                                                <th class="align-middle text-center">{{ $number4 }}</th>
                                                <th>{{ $transaksi->nama_outlet }}</th>
                                                <td>{{ $transaksi->kd_invoice }}</td>
                        ...
                        <div class="table-responsive" id="non_member_table_proses" hidden="">
                            <table class="table table-striped table-bordered zero-configuration">
                                <thead style="text-align: center;">
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                    <?php $number4 = 1; ?>
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'non_member' && $transaksi->status == 'proses')
                                            <tr>
                                                <th class="align-middle text-center">{{ $number4 }}</th>
                                                <th>{{ $transaksi->nama_outlet }}</th>
                                                <td>{{ $transaksi->kd_invoice }}</td>
                                    ...
                                    @foreach ($transaksis as $transaksi)
                                        @if ($transaksi->cek_member == 'non_member' && $transaksi->status == 'diantar')
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="label label-pill label-light">{{ $transaksi->status }}</span>
                                                </td>
                                                <td style="font-size: 16px;" class="text-center">
                                                    <button data-toggle="modal" data-target="#lihatTransaksiDiantar"
                                                        data-lihat="{{ $transaksi->id }}"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.lihat_diambil', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.modal_tgl_pemberian_ambil').html(moment(response.transaksis.tgl_pemberian)
                        .format('DD MMMM YYYY'));
                    $('.modal_tgl_selesai_ambil').html(moment(response.transaksis.tgl_selesai).format(
                        'DD MMMM YYYY'));
                    $('.modal_tgl_bayar_ambil').html(moment(response.transaksis.tgl_bayar).format(
                        'DD MMMM YYYY'));
                    ...
                    if (response.checkout_kilos != '') {
                        ...
                        for (var i = 0; i < response.checkout_kilos.length; i++) {
                            var no = i + 1;
                            isi_paket_kilo += '<tr><th>' + no + '</th><td>' + response.checkout_kilos[i]
                                .nama_paket + '</td><td>' + response.checkout_kilos[i].berat_barang +
                                '</td><td>Rp. ' + parseInt(response.checkout_kilos[i]
                                    .harga_paket_satuan).toLocaleString() +
                                '</td><td class="text-success">Rp. ' + parseInt(response.checkout_kilos[
                                    i].harga_paket).toLocaleString() + '</td></tr>';
                        }
                        $('.isi_paket_kilo_ambil').html(isi_paket_kilo);
                        $('.modal_ambil_total_paket').html('Rp. ' + parseInt(response.kiloan_total)
                            .toLocaleString());
                        $('#modal_ambil_subtotal_paket').html('Harga Paket <span>Rp. ' + parseInt(
                            response.kiloan_total).toLocaleString() + '</span>');
                        if (response.checkout_kilo.antar_jemput_paket == 1 || response.checkout_kilo
                            .harga_antar != 0) {
                            $('.line-pembayaran-diambil').prop('hidden', false);
                            $('#modal_ambil_biaya_antar').prop('hidden', false);
                            $('#modal_ambil_biaya_antar').html('Biaya Antar <span>Rp. ' + parseInt(
                                    response.checkout_kilo.harga_antar).toLocaleString() +
                                '</span>');
                        } else {
                        ...
                        $('.modal_ambil_subtotal').html('Rp. ' + parseInt(response.checkout_kilo
                            .harga_total).toLocaleString());
                    } else {
                        ...
                        for (var i = 0; i < response.checkout_satus.length; i++) {
                            ...
                            isi_paket_satu += '<tr><th>' + no + '</th><td>' + response.checkout_satus[i]
                                .nama_barang + '</td><td>' + ket_barang +
                                '</td><td class="text-center">' + response.checkout_satus[i]
                                .jumlah_barang + '</td><td>Rp. ' + parseInt(response.checkout_satus[i]
                                    .harga_barang_satuan).toLocaleString() +
                                '</td><td class="text-success">Rp. ' + parseInt(response.checkout_satus[
                                    i].harga_barang).toLocaleString() + '</td></tr>';
                        }
                        $('.isi_paket_satu_ambil').html(isi_paket_satu);
                        $('.modal_ambil_total_paket').html('Rp. ' + parseInt(response.satuan_total)
                            .toLocaleString());
                        $('#modal_ambil_subtotal_paket').html('Harga Paket - Barang(' + response
                            .checkout_satus.length + ') <span>Rp. ' + parseInt(response
                                .satuan_total).toLocaleString() + '</span>');
                        if (response.checkout_satu.harga_antar != 0) {
                            $('.line-pembayaran-diambil').prop('hidden', false);
                            $('#modal_ambil_biaya_antar').prop('hidden', false);
                            $('#modal_ambil_biaya_antar').html('Biaya Antar <span>Rp. ' + parseInt(
                                    response.checkout_satu.harga_antar).toLocaleString() +
                                '</span>');
                        } else {
                            $('.line-pembayaran-diambil').prop('hidden', true);
                            $('#modal_ambil_biaya_antar').prop('hidden', true);
                        ...
                        $('.modal_ambil_subtotal').html('Rp. ' + parseInt(response.checkout_satu
                            .harga_total).toLocaleString());
                    }
                    $('.modal_ambil_diskon').html(response.transaksis.diskon + ' %');
                    $('.modal_ambil_pajak').html(response.transaksis.pajak + ' %');
                    $('.modal_ambil_total').html('Rp. ' + parseInt(response.struks.harga_total)
                        .toLocaleString());
                    $('.modal_ambil_bayar').html('Rp. ' + parseInt(response.struks.harga_bayar)
                        .toLocaleString());
                    $('.modal_ambil_kembali').html('Rp. ' + parseInt(response.struks.harga_kembali)
                        .toLocaleString());
                }
            });
        });
        ...
        $(document).on('click', '.lihat_diantar', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.lokasi_alamat_antar').html(
                        '<i class="fa fa-map-marker text-danger" style="font-size: 18px;"></i> ' +
                        response.pelanggans.alamat_pelanggan + '');
                    ...
                    $('.modal_tgl_pemberian_antar').html(moment(response.transaksis.tgl_pemberian)
                        .format('DD MMMM YYYY'));
                    $('.modal_tgl_selesai_antar').html(moment(response.transaksis.tgl_selesai).format(
                        'DD MMMM YYYY'));
                    $('.modal_tgl_bayar_antar').html(moment(response.transaksis.tgl_bayar).format(
                        'DD MMMM YYYY'));
                    ...
                    if (response.checkout_kilos != '') {
                        ...
                        $('.modal_antar_total_paket').html('Rp. ' + parseInt(response.kiloan_total)
                            .toLocaleString());
                        $('#modal_antar_subtotal_paket').html('Harga Paket <span>Rp. ' + parseInt(
                            response.kiloan_total).toLocaleString() + '</span>');
                        if (response.checkout_kilo.antar_jemput_paket == 1 || response.checkout_kilo
                            .harga_antar != 0) {
                            $('.line-pembayaran-diantar').prop('hidden', false);
                            $('#modal_antar_biaya_antar').prop('hidden', false);
                            $('#modal_antar_biaya_antar').html('Biaya Antar <span>Rp. ' + parseInt(
                                    response.checkout_kilo.harga_antar).toLocaleString() +
                                '</span>');
                        } else {
                        ...
                        $('.modal_antar_subtotal').html('Rp. ' + parseInt(response.checkout_kilo
                            .harga_total).toLocaleString());
                    } else {
                        ...
                        $('.modal_antar_total_paket').html('Rp. ' + parseInt(response.satuan_total)
                            .toLocaleString());
                        $('#modal_antar_subtotal_paket').html('Harga Paket - Barang(' + response
                            .checkout_satus.length + ') <span>Rp. ' + parseInt(response
                                .satuan_total).toLocaleString() + '</span>');
                        if (response.checkout_satu.harga_antar != 0) {
                            $('.line-pembayaran-diantar').prop('hidden', false);
                        ...
                        $('.modal_antar_subtotal').html('Rp. ' + parseInt(response.checkout_satu
                            .harga_total).toLocaleString());
                    }
                    $('.modal_antar_diskon').html(response.transaksis.diskon + ' %');
                    $('.modal_antar_pajak').html(response.transaksis.pajak + ' %');
                    $('.modal_antar_total').html('Rp. ' + parseInt(response.struks.harga_total)
                        .toLocaleString());
                    $('.modal_antar_bayar').html('Rp. ' + parseInt(response.struks.harga_bayar)
                        .toLocaleString());
                    $('.modal_antar_kembali').html('Rp. ' + parseInt(response.struks.harga_kembali)
                        .toLocaleString());
                }
            });
        });
                    ...
                    if (response.checkout_kilos != '') {
                        ...
                        for (var i = 0; i < response.checkout_kilos.length; i++) {
                            ...
                            isi_paket_kilo += '<tr><th>' + no + '</th><td>' + response.checkout_kilos[i]
                                .nama_paket + '</td><td>' + response.checkout_kilos[i].berat_barang +
                                '</td><td>Rp. ' + parseInt(response.checkout_kilos[i]
                                    .harga_paket_satuan).toLocaleString() + '</td><td>Rp. ' + parseInt(
                                    response.checkout_kilos[i].harga_paket).toLocaleString() +
                                '</td></tr>';
                        }
                        $('.isi_paket_kilo').html(isi_paket_kilo);
                        $('.sub_total_bayar').val(parseInt(response.checkout_kilo.harga_total)
                            .toLocaleString());
                        $('.sub_total_bayar_2').val(response.checkout_kilo.harga_total);
                        $('.modal_total_paket').html('Rp. ' + parseInt(response.kiloan_total)
                            .toLocaleString());
                        if (response.checkout_kilo.antar_jemput_paket == 1 || response.checkout_kilo
                            .harga_antar != 0) {
                            $('.ket_biaya_antar').prop('hidden', false);
                            $('.modal_harga_antar').html('Rp. ' + parseInt(response.checkout_kilo
                                .harga_antar).toLocaleString());
                        } else {
                            $('.ket_biaya_antar').prop('hidden', true);
                            $('.modal_harga_antar').html('');
                        }
                        $('.modal_total').html('Rp. ' + parseInt(response.checkout_kilo.harga_total)
                            .toLocaleString());
                    } else {
                        ...
                        for (var i = 0; i < response.checkout_satus.length; i++) {
                            ...
                            isi_paket_satu += '<tr><th>' + no + '</th><td>' + response.checkout_satus[i]
                                ...
                                '</td><td class="text-center">' + response.checkout_satus[i]
                                .jumlah_barang + '</td><td>Rp. ' + parseInt(response.checkout_satus[i]
                                    .harga_barang_satuan).toLocaleString() + '</td><td>Rp. ' + parseInt(
                                    response.checkout_satus[i].harga_barang).toLocaleString() +
                                '</td></tr>';
                        }
                        $('.isi_paket_satu').html(isi_paket_satu);
                        $('.sub_total_bayar').val(parseInt(response.checkout_satu.harga_total)
                            .toLocaleString());
                        $('.sub_total_bayar_2').val(response.checkout_satu.harga_total);
                        $('.modal_total_paket').html('Rp. ' + parseInt(response.satuan_total)
                            .toLocaleString());
                        if (response.checkout_satu.harga_antar != 0) {
                            $('.ket_biaya_antar').prop('hidden', false);
                            $('.modal_harga_antar').html('Rp. ' + parseInt(response.checkout_satu
                                .harga_antar).toLocaleString());
                        } else {
                            $('.ket_biaya_antar').prop('hidden', true);
                            $('.modal_harga_antar').html('');
                        }
                        $('.modal_total').html('Rp. ' + parseInt(response.checkout_satu.harga_total)
                            .toLocaleString());
                    }
                    if (response.struks != '') {
                        ...
                        $('.kembali_bayar').val(parseInt(response.struks.harga_kembali)
                            .toLocaleString());
                        $('.kembali_bayar_2').val(response.struks.harga_kembali);
                    } else {
                        if (response.checkout_kilos != '') {
                            $('.total_bayar').val(parseInt(response.checkout_kilo.harga_total)
                                .toLocaleString());
                            $('.total_bayar_2').val(response.checkout_kilo.harga_total);
                        } else {
                            $('.total_bayar').val(parseInt(response.checkout_satu.harga_total)
                                .toLocaleString());
        ...
        $(document).on('click', '#all-btn', function() {
            ...
            $('#baru-btn').addClass('btn-outline-primary');
            $('#baru-btn').removeClass('btn-primary');
        ...
        $(document).on('click', '#baru-btn', function() {
            all_check = 0;
            baru_check = 1;
            proses_check = 0;
            selesai_check = 0;
        ...
        $(document).on('click', '#selesai-btn', function() {
            ...
            $(this).removeClass('btn-outline-primary');
            $('#all-btn').addClass('btn-outline-primary');
            $('#all-btn').remove('btn-primary');
            $('#baru-btn').addClass('btn-outline-primary');
            $('#baru-btn').remove('btn-primary');
            $('#proses-btn').addClass('btn-outline-primary');
            $('#proses-btn').removeClass('btn-primary');
            $('#diantar-btn').addClass('btn-outline-primary');
            $('#diantar-btn').removeClass('btn-primary');
        ...
        function checkTable() {
            if (member_check == 1 && all_check == 1) {
                $('#member_table').prop('hidden', false);
                $('#member_table_baru').prop('hidden', true);
                $('#member_table_proses').prop('hidden', true);
                ...
                $('#non_member_table_baru').prop('hidden', true);
                $('#non_member_table_proses').prop('hidden', true);
            ...
            } else if (member_check == 1 && baru_check == 1) {
                $('#member_table_baru').prop('hidden', false);
                $('#member_table_proses').prop('hidden', true);
                $('#member_table_selesai').prop('hidden', true);
                $('#member_table_diantar').prop('hidden', true);
                $('#member_table_diambil').prop('hidden', true);
                ...
                $('#non_member_table_diantar').prop('hidden', true);
                $('#non_member_table_diambil').prop('hidden', true);
            } else if (member_check == 1 && proses_check == 1) {
                $('#member_table').prop('hidden', true);
                $('#member_table_baru').prop('hidden', true);
                $('#member_table_proses').prop('hidden', false);
                $('#member_table_selesai').prop('hidden', true);
                $('#member_table_diantar').prop('hidden', true);
                $('#member_table_diambil').prop('hidden', true);
                $('#non_member_table').prop('hidden', true);
                ...
                $('#non_member_table_diantar').prop('hidden', true);
                $('#non_member_table_diambil').prop('hidden', true);
            } else if (member_check == 1 && selesai_check == 1) {
                $('#member_table').prop('hidden', true);
                $('#member_table_baru').prop('hidden', true);
                $('#member_table_proses').prop('hidden', true);
                ...
                $('#non_member_table_diantar').prop('hidden', true);
                $('#non_member_table_diambil').prop('hidden', true);
            } else if (non_member_check == 1 && all_check == 1) {
                $('#member_table').prop('hidden', true);
                $('#member_table_baru').prop('hidden', true);
                $('#member_table_proses').prop('hidden', true);
                $('#member_table_selesai').prop('hidden', true);
                ...
                $('#non_member_table_diantar').prop('hidden', true);
                $('#non_member_table_diambil').prop('hidden', true);
            } else if (non_member_check == 1 && baru_check == 1) {
                $('#member_table').prop('hidden', true);
                $('#member_table_baru').prop('hidden', true);
                $('#member_table_proses').prop('hidden', true);
                $('#member_table_selesai').prop('hidden', true);
                ...
                $('#member_table_diambil').prop('hidden', true);
                $('#non_member_table').prop('hidden', true);
                $('#non_member_table_baru').prop('hidden', false);
                $('#non_member_table_proses').prop('hidden', true);
                $('#non_member_table_selesai').prop('hidden', true);
                $('#non_member_table_diantar').prop('hidden', true);
                $('#non_member_table_diambil').prop('hidden', true);
            } else if (non_member_check == 1 && proses_check == 1) {
                $('#member_table').prop('hidden', true);
                $('#member_table_baru').prop('hidden', true);
                $('#member_table_proses').prop('hidden', true);
                $('#member_table_selesai').prop('hidden', true);
                ...
                $('#non_member_table').prop('hidden', true);
                $('#non_member_table_baru').prop('hidden', true);
                $('#non_member_table_proses').prop('hidden', false);
                $('#non_member_table_selesai').prop('hidden', true);
                $('#non_member_table_diantar').prop('hidden', true);
                $('#non_member_table_diambil').prop('hidden', true);
