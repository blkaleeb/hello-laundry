...
@section('css')
    ...
    @if (auth()->user()->role == 'admin' || auth()->user()->role == 'kasir')
        <style type="text/css">
            #table-pengunjung tr th,
            #table-pengunjung tr td {
                font-size: 12px;
            }

            #table-pemasukan tr th,
            #table-pemasukan tr td {
                font-size: 12px;
            }
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="text-primary">
                                            {{ date('d M Y', strtotime(\App\Models\Transaksi::min('tgl_bayar'))) . ' - ' . date('d M Y', strtotime(\App\Models\Transaksi::max('tgl_bayar'))) }}
                                        </h4>
                                        <p>Total Pemasukan : <b class="text-dark">Rp.
                                                {{ number_format(\App\Models\Struk::sum('harga_bayar'), 2, ',', '.') }}</b>
                                        </p>
                                    </div>
                                    <div class="col-md-12">
                                        <hr>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <table class="mb-3 text-center tabel-ket" style="width: 100%;">
                                            <tr>
                                                <th style="font-size: 14px;"><i
                                                        class="fa fa-angle-double-up text-success up_status"
                                                        aria-hidden="true"></i></th>
                                                <th>:</th>
                                                <th class="text-left">Kenaikan</th>
                                                <th style="font-size: 14px;"><i
                                                        class="fa fa-angle-double-down text-danger up_status"
                                                        aria-hidden="true"></i></th>
                                                <th>:</th>
                                        ...
                                        <input type="text" placeholder="Cari"
                                            class="form-control cari_input_pemasukan form-control-xs" name="">
                                    </div>
                                    <div class="col-md-12">
                                                ...
                                                @foreach ($semua_pelanggan_bayar as $pelanggan)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ date('d M Y', strtotime($pelanggan->tgl_bayar)) }}</td>
                                                        @php
                                                            $total_hari = \App\Models\Transaksi::join(
                                                                'struks',
                                                                'struks.kd_invoice',
                                                                '=',
                                                                'transaksis.kd_invoice',
                                                            )
                                                                ->where('transaksis.tgl_bayar', $pelanggan->tgl_bayar)
                                                                ->sum('struks.harga_bayar');
                                                        @endphp
                                                        <td class="total_pemasukan font-weight-bold"
                                                            style="padding-left: 30px;" data-harga="{{ $total_hari }}">Rp.
                                                            {{ number_format($total_hari, 2, ',', '.') }}</td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="text-primary">
                                            {{ date('d M Y', strtotime(\App\Models\Transaksi::min('tgl_pemberian'))) . ' - ' . date('d M Y', strtotime(\App\Models\Transaksi::max('tgl_pemberian'))) }}
                                        </h4>
                                        <p>Jumlah Pelanggan : <b
                                                class="text-dark">{{ \App\Models\Transaksi::all()->count() }}</b></p>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <input type="text" placeholder="Cari"
                                            class="form-control cari_input_jumlah form-control-xs" name="">
                                    </div>
                                    <div class="col-md-12">
                                            ...
                                            <tbody class="isi_tabel_jumlah">
                                                @foreach ($semua_pelanggan_harian as $pelanggan)
                                                    <tr>
                                                        <th style="padding-left: 20px;">{{ $loop->iteration }}</th>
                                                        <td class="text-center">
                                                            {{ date('d M Y', strtotime($pelanggan->tgl_pemberian)) }}</td>
                                                        @php
                                                            $jumlah_pelanggan = \App\Models\Transaksi::where(
                                                                'tgl_pemberian',
                                                                $pelanggan->tgl_pemberian,
                                                            )->count();
                                                        @endphp
                                                        <td class="text-center jumlah_hari font-weight-bold">
                                                            {{ $jumlah_pelanggan }}</td>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-between">
                                    ...
                                    <div class="semua-btn">
                                        <button class="btn btn-sm font-weight-bold text-dark" data-toggle="modal"
                                            data-target="#jmlPelangganModal">Semua <i class="fa fa-long-arrow-right"
                                        ...
                                        <tbody>
                                            @foreach ($pelanggan_terbaru as $pelanggan)
                                                <tr>
                                                    ...
                                                    @endphp
                                                    <td>{{ Carbon\Carbon::parse($pelanggan->created_at)->diffForHumans() }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-between">
                                    <div class="judul">
                                        ...
                                        <h3>Rp. {{ number_format(\App\Models\Struk::sum('harga_bayar'), 2, ',', '.') }}
                                        </h3>
                                    </div>
                                    <div class="semua-btn">
                                        <button class="btn btn-sm font-weight-bold text-dark" data-toggle="modal"
                                            data-target="#pemasukanModal">Semua <i class="fa fa-long-arrow-right"
                                                aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                <div class="col-md-12 mt-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <p class="ml-5 mt-4 text-dark" style="font-weight: 500;">Lorem ipsum dolor sit amet,
                                    ...
                                    <form method="POST" class="form_edit_identitas" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex justify-content-between" style="margin-bottom: -10px;">
                                            ...
                                            <div class="edit-profil-button" style="margin-top: -10px;">
                                                <button type="button" style="border: 0px; background-color: #fff;"
                                                    class="btn text-primary edit_identitas_btn"><i class="fa fa-pencil"
                                                        aria-hidden="true"></i></button>
                                                <button type="submit" style="border: 0px; background-color: #fff;"
                                                    class="btn text-primary update_identitas_btn" hidden=""><i
                                        ...
                                        <div class="text-center">
                                            <div class="foto">
                                                ...
                                                <div class="upload-btn-wrapper ubah_foto_file" hidden="">
                                                    ...
                                                    <input type="file" name="ubah_foto_input" class="ubah_foto_input"
                                                        hidden="">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="btn btn-sm font-weight-bold mt-1"
                                                style="background-color: #6fd96f; color: #fff;">{{ auth()->user()->role }}
                                            </div>
                                        </div>
                                        <table class="table_profil mt-3" style="width: 100%;">
                                            ...
                                            <tr class="align-top">
                                                ...
                                                <td class="input_ubah" hidden=""><input required=""
                                                        type="text" name="ubah_nama_pelanggan"
                                            ...
                                            <tr class="align-top">
                                                ...
                                                <td class="input_ubah" hidden=""><input required=""
                                                        type="text" name="ubah_email_pelanggan"
                                                        value="{{ $email->email_pelanggan }}"></td>
                                            </tr>
                                            <tr class="align-top">
                                                <th>No HP</th>
                                                <td>:</td>
                                                ...
                                                <td class="input_ubah" hidden=""><input required=""
                                                        type="text" name="ubah_no_hp_pelanggan" class="number_input"
                                                        value="{{ $no_hp->no_hp_pelanggan }}"></td>
                                            </tr>
                                            <tr class="align-top">
                                                <th>Alamat</th>
                                                <td>:</td>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control pilih_outlet" name="pilih_outlet">
                                        @foreach ($outlets as $outlet)
                                            <option value="{{ $outlet->id }}" data-loop="{{ $loop->iteration }}">
                                                {{ $outlet->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-12 mt-3">
                                    ...
                                    <div class="alert alert-danger"><i class="fa fa-map-marker"
                                            aria-hidden="true"></i>&nbsp;&nbsp;<a href="" target="_blank"
                                            class="alert-link alamat_outlet"></a></div>
                                </div>
                                <div class="col-md-12">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.status_jumlah').each(function() {
                    ...
                    if (parseInt(hasil) < 0) {
                        $(this).html(
                            '<i class="fa fa-angle-double-down text-danger down_status" aria-hidden="true"></i>'
                        );
                    } else if (parseInt(hasil) > 0) {
                        $(this).html(
                            '<i class="fa fa-angle-double-up text-success up_status" aria-hidden="true"></i>'
                        );
                    } else {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [
                            @foreach ($pelanggan_harian->reverse() as $pelanggan)
                                @php
                                    $jumlah_pelanggan = \App\Models\Transaksi::where('tgl_pemberian', $pelanggan->tgl_pemberian)->count();
                                @endphp
                                    '{{ $jumlah_pelanggan }}',
                            @endforeach
                        ],
            ...
            $(document).on('change', '.pilih_outlet', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('.alamat_outlet').attr('href', 'http://maps.google.com/?q=' + response.outlets
                            .alamat);
