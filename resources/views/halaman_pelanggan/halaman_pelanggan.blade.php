                                    ...
                                    @foreach ($pelanggans as $pelanggan)
                                        @if ($pelanggan->cek_member == 'member')
                                            <tr>
                                                ...
                                                @endphp
                                                {{-- @dd($users->avatar) --}}
                                                <th><img src="{{ asset('/pictures/' . $users->avatar) }}"
                                                        class="rounded-circle mr-3 fotouser" alt="">
                                                    {{ $pelanggan->nama_pelanggan }}</th>
                                                ...
                                                <td style="font-size: 16px;" class="text-center">
                                                    <a href="{{ url('/detail_pelanggan_member/' . $pelanggan->id) }}"
                                                        class="btn btn-sm btn-outline-primary btn-flat font-weight-bold">Lihat</a>&nbsp;&nbsp;<a
                                                        href="{{ url('/layanan_member/' . $pelanggan->id) }}"
                                                        class="btn btn-sm btn-primary btn-flat font-weight-bold">Layanan</a>
                                                </td>
                                            </tr>
                                            <?php $number1++; ?>
                                        @endif
                                    ...
                                    @foreach ($pelanggans as $pelanggan)
                                        @if ($pelanggan->cek_member == 'non_member')
                                            <tr>
                                                ...
                                                <td>{{ $pelanggan->no_hp_pelanggan }}</td>
                                                <td style="font-size: 16px;" class="text-center">
                                                    <a href="{{ url('/detail_pelanggan_non_member/' . $pelanggan->id) }}"
                                                        class="btn btn-sm btn-outline-primary btn-flat font-weight-bold">Lihat</a>
                                                </td>
                                            </tr>
                                            <?php $number2++; ?>
                                        @endif
