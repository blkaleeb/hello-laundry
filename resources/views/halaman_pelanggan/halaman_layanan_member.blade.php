                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right foto-pelanggan">
                                <img src="{{ asset('/pictures/' . $akun_pelanggans->avatar) }}"
                                    class="rounded-circle mr-3 fotouser" alt="">
                            </div>
                            ...
                            <div class="layanan_member">
                                <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control" id="metode_pembayaran_kilo"
                                                        ...
                                                        <option value="" class="metode_pembayaran_kilo_1">-- Pilih
                                                            Metode Pembayaran --</option>
                                                        <option value="outlet" class="metode_pembayaran_kilo_2">Bayar di
                                                            outlet</option>
                                            ...
                                            <div class="col-lg-12 mt-3">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control" id="metode_pembayaran_satu"
                                                        ...
                                                        <option value="" class="metode_pembayaran_satu_1">-- Pilih
                                                            Metode Pembayaran --</option>
                                                        <option value="outlet" class="metode_pembayaran_satu_2">Bayar di
                                                            outlet</option>
                                    ...
                                    <div class="col-lg-12 text-right">
                                        <button class="btn btn-primary next-slide-2 kirim-btn"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '.layanan-member-form', function(e) {
            ...
            if (($(".layanan-member-form").valid() == true && check_paket_laundry == true) || ($(
                    ".layanan-member-form").valid() == true && jumlah_barang_satuan != 0)) {
                if (cek_metode_pembayaran_kilo == 1 || cek_metode_pembayaran_satu == 1) {
                    if (bayar_bayar_kilo >= total_bayar_kilo_2 || bayar_bayar_satu >= total_bayar_satu_2) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data == 'sukses') {
                                    window.open("{{ url('/detail_pelanggan_member/' . $id) }}",
                                        "_self");
                                }
                            }
                        });
