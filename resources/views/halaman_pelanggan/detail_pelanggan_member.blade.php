...
@section('css')
    ...
    <style type="text/css">
        ...
        .tabel-identitas tr td,
        .tabel-identitas tr th {
            max-width: 120px;
        }
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('/detail_pelanggan_member/' . $id) }}">Detail
                        Pelanggan</a></li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-md-6">
                                    <table style="width: 100%;" class="table-total">
                                        ...
                                        <tr>
                                            <td colspan="2" style="font-size: 12px;">(Belum termasuk diskon dan pajak)
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button"
                                        class="btn btn-danger btn-flat font-weight-bold btn-block batal-btn-kilo"><i
                                            class="fa fa-ban"></i>&nbsp;&nbsp;Batalkan Pesanan</button>
                                    <button type="button"
                                        class="pdf-btn btn btn-primary btn-flat font-weight-bold btn-block"><i
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-md-6">
                                    <table style="width: 100%;" class="table-total">
                                        ...
                                        <tr>
                                            <th colspan="2" style="font-size: 12px;">(Belum termasuk diskon dan pajak)
                                            </th>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button"
                                        class="btn btn-danger btn-flat font-weight-bold btn-block batal-btn-satu"><i
                                            class="fa fa-ban"></i>&nbsp;&nbsp;Batalkan Pesanan</button>
                                    <button type="button"
                                        class="pdf-btn btn btn-primary btn-flat font-weight-bold btn-block"><i
                                            class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Cetak PDF</button>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center mb-4">
                            <img class="mr-3 rounded-circle" src="{{ asset('/pictures/' . $akun_pelanggans->avatar) }}"
                            ...
                            <div class="col-md-12">
                                <table style="width: 100%; margin-left: -10px;" class="tabel-identitas">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px;" class="align-top">:</td>
                                        <td style="padding: 5px;" class="align-top">{{ $pelanggans->no_hp_pelanggan }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="padding: 5px;" class="text-dark text-left align-top">Email</th>
                                        <td style="padding: 5px;" class="align-top">:</td>
                                        <td style="padding: 5px;" class="align-top">{{ $pelanggans->email_pelanggan }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="3" style="padding: 5px;" class="align-top">
                                            {{ $pelanggans->alamat_pelanggan }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        <div class="row mt-3 mb-1">
                            <div class="col">
                                <div class="card card-profile text-center">
                                    <span class="mb-1 text-primary"><i class="fa fa-user-o"
                                    ...
                                    <table style="width: 100%; margin: 5px;" class="text-left tabel-identitas">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 5px;" class="align-top">
                                                {{ $akun_pelanggans->username }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 5px;" class="align-top">
                                                {{ $pelanggans->password }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <a href="{{ url('/hapus_pelanggan/' . $id) }}"
                                    class="btn btn-flat btn-danger font-weight-bold"><i
                                        class="fa fa-trash-o"></i>&nbsp;&nbsp;Hapus Pelanggan</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12 d-flex justify-content-between">
                                ...
                                <div class="align-items-center">
                                    <div class="btn-group dropleft mb-1" id="filterStatusKilo">
                                        <button type="button"
                                            class="btn btn-primary btn-sm dropdown-toggle font-weight-bold"
                                            style="height: 35px;" data-toggle="dropdown">Filter Status</button>
                                        <div class="dropdown-menu"><a class="dropdown-item filter-status-kilo-btn"
                                                data-status="">Semua</a> <a class="dropdown-item filter-status-kilo-btn"
                                                data-status="baru">Baru</a> <a
                                                class="dropdown-item filter-status-kilo-btn"
                                                data-status="proses">Proses</a> <a
                                                class="dropdown-item filter-status-kilo-btn"
                                                data-status="selesai">Selesai</a> <a
                                                class="dropdown-item filter-status-kilo-btn"
                                                data-status="diantar">Diantar</a> <a
                                                class="dropdown-item filter-status-kilo-btn"
                                    ...
                                    <div class="btn-group dropleft mb-1" id="filterStatusSatu" hidden="">
                                        <button type="button"
                                            class="btn btn-primary btn-sm dropdown-toggle font-weight-bold"
                                            style="height: 35px;" data-toggle="dropdown">Filter Status</button>
                                        <div class="dropdown-menu"><a class="dropdown-item filter-status-satu-btn"
                                                data-status="">Semua</a> <a class="dropdown-item filter-status-satu-btn"
                                                data-status="baru">Baru</a> <a
                                                class="dropdown-item filter-status-satu-btn"
                                                data-status="proses">Proses</a> <a
                                                class="dropdown-item filter-status-satu-btn"
                                                data-status="selesai">Selesai</a> <a
                                                class="dropdown-item filter-status-satu-btn"
                                    ...
                                    <select id="maxRowsSatu" class="form-control-sm ml-2" style="width: 100px;"
                                        hidden="">
                                        <option value="9999">Semua</option>
                                        <option value="5">5</option>
                                        <option value="10">10</option>
                                            ...
                                            @if ($checkout_kilos != 0)
                                                <tr class="table-light">
                                                    ...
                                                    <td class="text-center">
                                                        {{ date('d M Y', strtotime($transaksi->tgl_pemberian)) }}</td>
                                                    <td class="text-center">
                                                        {{ date('d M Y', strtotime($transaksi->tgl_selesai)) }}</td>
                                                    <td>
                                                        @if ($transaksi->status == 'baru')
                                                            <span
                                                                class="label label-pill label-info text-white">{{ $transaksi->status }}</span>
                                                        @elseif($transaksi->status == 'proses')
                                                            <span
                                                                class="label label-pill label-warning text-white">{{ $transaksi->status }}</span>
                                                        @elseif($transaksi->status == 'selesai')
                                                            <span
                                                                class="label label-pill label-success text-white">{{ $transaksi->status }}</span>
                                                        @elseif($transaksi->status == 'diantar')
                                                            <span
                                                                class="label label-pill label-danger text-white">{{ $transaksi->status }}</span>
                                                        @elseif($transaksi->status == 'diambil')
                                                            <span
                                                                class="label label-pill label-primary text-white">{{ $transaksi->status }}</span>
                                                        @endif
                                                    </td>
                                                    <td><button
                                                            class="btn btn-outline-primary font-weight-bold btn-sm btn-lihat-kilo"
                                                            data-transaksi="{{ $transaksi->id }}" type="button"
                                                            data-toggle="modal"
                                                            data-target="#paketKiloModal">Lihat</button></td>
                                                </tr>
                                            @endif
                                        @endforeach
                                    </tbody>
                                        ...
                                        @foreach ($transaksis as $transaksi)
                                            ...
                                            @if ($checkout_satus != 0)
                                                <tr class="table-light">
                                                    ...
                                                    <td><button
                                                            class="btn btn-outline-primary font-weight-bold btn-sm btn-lihat-satu"
                                                            data-transaksi="{{ $transaksi->id }}" type="button"
                                                            data-toggle="modal"
                                                            data-target="#paketSatuModal">Lihat</button></td>
                                                </tr>
                                            @endif
                                        @endforeach
                                    </tbody>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.btn-lihat-kilo', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.modal_tgl_pemberian').html(moment(response.transaksis.tgl_pemberian).format(
                        'DD MMMM YYYY'));
                    $('.modal_tgl_selesai').html(moment(response.transaksis.tgl_selesai).format(
                        'DD MMMM YYYY'));
                    if (response.transaksis.tgl_bayar != null) {
                        $('.modal_tgl_bayar').html(moment(response.transaksis.tgl_bayar).format(
                            'DD MMMM YYYY'));
                    } else {
                    ...
                    if (response.transaksis.status != 'diambil' && response.transaksis.status !=
                        'diantar') {
                    ...
                    for (var i = 0; i < response.checkout_kilos.length; i++) {
                        var no = i + 1;
                        isi_paket_kilo += '<tr><th>' + no + '</th><th>' + response.checkout_kilos[i]
                            .nama_paket + '</th><td>' + response.checkout_kilos[i].berat_barang +
                            '</td><td>Rp. ' + parseInt(response.checkout_kilos[i].harga_paket_satuan)
                            .toLocaleString() + '</td><td>Rp. ' + parseInt(response.checkout_kilos[i]
                                .harga_paket_total).toLocaleString() + '</td></tr>';
                    }
                    $('.isi_paket_kilo').html(isi_paket_kilo);
                    $('.modal_total_paket').html('Rp. ' + parseInt(response.paket_kilo_total)
                        .toLocaleString());
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < response.checkout_satus.length; i++) {
                        ...
                        isi_paket_satu += '<tr><th>' + no + '</th><th>' + response.checkout_satus[i]
                            .nama_barang + '</th><td>' + ket_barang + '</td><td>' + response
                            .checkout_satus[i].jumlah_barang + '</td><td>Rp. ' + parseInt(response
                                .checkout_satus[i].harga_barang_satuan).toLocaleString() +
                            '</td><td>Rp. ' + parseInt(response.checkout_satus[i].harga_barang_total)
                            .toLocaleString() + '</td></tr>';
                    }
                    $('.isi_paket_satu').html(isi_paket_satu);
                    $('.modal_total_paket').html('Rp. ' + parseInt(response.paket_satu_total)
                        .toLocaleString());
        ...
        $('#maxRowsKilo').on('change', function() {
            ...
            if (totalRows > maxRows) {
                ...
                for (var i = 1; i <= pagenum;) {
                    $('.pagination_kilo').append('<li class="page-item" data-page="' + i +
        ...
        $('#maxRowsSatu').on('change', function() {
            ...
            if (totalRows > maxRows) {
                var pagenum = Math.ceil(totalRows / maxRows);
                for (var i = 1; i <= pagenum;) {
                    $('.pagination_satu').append('<li class="page-item" data-page="' + i +
                        '">\<span class="page-link">' + i++ +
                        '<span class="sr-only">(current)</span></span>\</li>').show();
                }
