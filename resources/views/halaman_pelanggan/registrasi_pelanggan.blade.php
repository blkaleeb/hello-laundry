...
@section('konten')
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('/registrasi_pelanggan') }}">Registrasi Pelanggan</a>
                </li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            <button type="button" class="btn btn-primary bayar-outlet-kilo-btn" data-toggle="modal"
                data-target="#bayarOutletKiloan" hidden="">bayarOutletKiloan</button>
            <button type="button" class="btn btn-primary bayar-outlet-satu-btn" data-toggle="modal"
                data-target="#bayarOutletSatuan" hidden="">bayarOutletSatuan</button>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills mb-3" style="border-bottom: 1px solid #7571f9;">
                            ...
                            <li class="nav-item" hidden="hidden"><a href="#slide-1" class="nav-link active slide-1-btn"
                                    data-toggle="tab" aria-expanded="false"></a>
                            </li>
                            <li class="nav-item"><a href="#" class="layanan-tab nav-link">Layanan Laundry</a>
                            </li>
                            <li class="nav-item" hidden="hidden"><a href="#slide-2" class="nav-link slide-2-btn"
                                    data-toggle="tab" aria-expanded="false"></a>
                            </li>
                            <li class="nav-item"><a href="#" class="akun-tab nav-link">Buat Akun</a>
                            </li>
                            <li class="nav-item" hidden="hidden"><a href="#slide-3" class="nav-link slide-3-btn"
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly"
                                                            name="sub_total_bayar_satu"
                                                            class="form-control sub_total_bayar_satu">
                                                        <input type="text" readonly="readonly"
                                                            name="sub_total_bayar_satu_2"
                                                            class="form-control sub_total_bayar_satu_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="number" min="0" max="100"
                                                            name="diskon_bayar_satu" class="form-control diskon_bayar_satu">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="number" min="0" max="100"
                                                            name="pajak_bayar_satu" class="form-control pajak_bayar_satu">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly" name="total_bayar_satu"
                                                            class="form-control total_bayar_satu">
                                                        <input type="text" readonly="readonly"
                                                            name="total_bayar_satu_2"
                                                            class="form-control total_bayar_satu_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="bayar_bayar_satu"
                                                            class="form-control bayar_bayar_satu number_input">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly"
                                                            name="kembali_bayar_satu"
                                                            class="form-control kembali_bayar_satu">
                                                        <input type="text" readonly="readonly"
                                                            name="kembali_bayar_satu_2"
                                                            class="form-control kembali_bayar_satu_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly"
                                                            name="sub_total_bayar_kilo"
                                                            class="form-control sub_total_bayar_kilo">
                                                        <input type="text" readonly="readonly"
                                                            name="sub_total_bayar_kilo_2"
                                                            class="form-control sub_total_bayar_kilo_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="number" min="0" max="100"
                                                            name="diskon_bayar_kilo"
                                                            class="form-control diskon_bayar_kilo">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="number" min="0" max="100"
                                                            name="pajak_bayar_kilo" class="form-control pajak_bayar_kilo">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly" name="total_bayar_kilo"
                                                            class="form-control total_bayar_kilo">
                                                        <input type="text" readonly="readonly"
                                                            name="total_bayar_kilo_2"
                                                            class="form-control total_bayar_kilo_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="bayar_bayar_kilo"
                                                            class="form-control bayar_bayar_kilo number_input">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly="readonly"
                                                            name="kembali_bayar_kilo"
                                                            class="form-control kembali_bayar_kilo">
                                                        <input type="text" readonly="readonly"
                                                            name="kembali_bayar_kilo_2"
                                                            class="form-control kembali_bayar_kilo_2" hidden="">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                            ...
                            <div class="tab-content br-n pn">
                                <div id="slide-1" class="tab-pane active identitas-tab">
                                    <div class="row align-items-center">
                                        <div class="col-lg-12">
                                            <div class="alert alert-info">Layanan pelanggan member tersedia pada halaman <a
                                                    href="{{ url('/kelola_pelanggan') }}" class="alert-link">Kelola
                                                    Pelanggan</a></div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Nama" name="nama_pelanggan">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control"
                                                                    placeholder="No Handphone" name="no_hp_pelanggan"
                                                                    id="no_hp_pelanggan">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <div style="margin-bottom: -10px;">
                                                                    <p class="font-weight-bold text-dark">Jenis Kelamin :
                                                                    </p>
                                                                </div>
                                                                <label class="radio-inline mr-3">
                                                                    <input type="radio" name="jk_pelanggan"
                                                                        value="L"> Laki-laki</label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="jk_pelanggan"
                                                                        value="P"> Perempuan</label>
                                                            </div>
                                                            <div class="jk_pelanggan_error" style="margin-top: -20px;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                ...
                                                <div class="col-lg-12 mt-3 text-right">
                                                    <button class="btn btn-primary next-slide-1"
                                ...
                                <div id="slide-2" class="tab-pane layanan-tab">
                                    <div class="row align-items-center">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label class="radio-inline mr-3">
                                                    <input type="radio" name="jenis_laundry" checked="checked"
                                                        value="kiloan"> Kiloan</label>
                                                <label class="radio-inline ml-5 mr-3">
                                                    <input type="radio" name="jenis_laundry" value="satuan">
                                                    Satuan</label>
                                            </div>
                                            <div class="alert alert-primary deskripsi-jasa"><b>Deskripsi Jasa
                                                    :</b><br>Perhitungan biaya berdasarkan timbangan yang di laundry</div>
                                        </div>
                                        <div class="col-lg-12 mb-5" id="hal_paket_kiloan">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="berat_barang"
                                                            name="berat_barang" placeholder="Masukkan Berat"
                                                            step="0.50">
                                                        <div class="input-group-append">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <hr>
                                                    <div class="input-group">
                                                        <select class="form-control" id="metode_pembayaran_kilo"
                                                            name="metode_pembayaran_kilo" disabled="">
                                                            <option value="" class="metode_pembayaran_kilo_1">--
                                                                Pilih Metode Pembayaran --</option>
                                                            <option value="outlet" class="metode_pembayaran_kilo_2">Bayar
                                                                di outlet</option>
                                                            <option value="rumah" class="metode_pembayaran_kilo_3"
                                                                data-antar="">Bayar di rumah</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="jasa_antar_checkbox_kiloan">Jasa Antar</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mt-4 checkout_box_kilo" hidden="">
                                                <div class="col-lg-3 offset-lg-9">
                                                    <div class="basic-list-group">
                                                        <ul class="list-group">
                                                            <li class="list-group-item active font-weight-bold">Check Out
                                                            </li>
                                                            <li class="list-group-item">
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="jenis_paket_kiloan"></div>
                                                                    <div class="harga_paket_kiloan"></div>
                                                                    <input type="text" name="harga_paket_kiloan"
                                                                        class="harga_paket_kiloan_input" hidden="">
                                                                </div>
                                                                <div
                                                                    class="d-flex justify-content-between jasa_antar_kiloan">
                                                                    <div class="antar_nama_kiloan"></div>
                                                                    <div class="antar_harga_kiloan"></div>
                                                                    <input type="text" name="antar_harga_kiloan"
                                                                        class="antar_harga_kiloan_input" hidden=""
                                                                        value="0">
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item">
                                                                <div
                                                                    ...
                                                                    <input type="text" name="total_kiloan_rp"
                                                                        class="total_kiloan_rp_input" hidden="">
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 mt-3 offset-lg-9 text-left antar_harga_kiloan_error">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mb-5" id="hal_paket_satuan" hidden="">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mt-3">
                                                    ...
                                                    <hr>
                                                    <div class="input-group">
                                                        <select class="form-control" id="metode_pembayaran_satu"
                                                            name="metode_pembayaran_satu" disabled="">
                                                            <option value="" class="metode_pembayaran_satu_1">--
                                                                Pilih Metode Pembayaran --</option>
                                                            <option value="outlet" class="metode_pembayaran_satu_2">Bayar
                                                                di outlet</option>
                                                            <option value="rumah" class="metode_pembayaran_satu_3"
                                                                data-antar="">Bayar di rumah</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-lg-12 mt-3 jasa_antar_checkbox_satuan" hidden="">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="jasa_antar_checkbox_satuan">Jasa Antar</label>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <input type="text" name="harga_barang_satuan"
                                                                        class="harga_barang_satuan_input" hidden="">
                                                                </div>
                                                                <div
                                                                    class="d-flex justify-content-between jasa_antar_satuan">
                                                                    <div class="antar_nama_satuan"></div>
                                                                    <div class="antar_harga_satuan"></div>
                                                                    <input type="text" name="antar_harga_satuan"
                                                                        class="antar_harga_satuan_input" value="0"
                                                                        hidden="">
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item">
                                                                <div
                                                                    ...
                                                                    <input type="text" name="total_satuan_rp"
                                                                        class="total_satuan_rp_input" hidden="">
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 mt-3 offset-lg-9 text-left antar_harga_satuan_error">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="slide-3" class="tab-pane akun-tab">
                                    <div class="row align-items-center">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="val-username"
                                                        name="username" placeholder="Masukkan username" disabled>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="password" class="form-control" id="val-password"
                                                        name="password" placeholder="Masukkan password" disabled>
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-lg-12 d-flex justify-content-between">
                                                    <button class="btn btn-primary prev-slide-3"
                                                        type="button">Kembali</button>
                                                    <button class="btn btn-primary next-slide-3 simpan-akhir"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        /* Check kalau member di centang atau tidak */

        // var member_checking = document.querySelector("input[name=cek_member]");

        // member_checking.addEventListener('change', function() {
        //     if (this.checked) {
        //         document.getElementById("val-username").disabled = false;
        //         document.getElementById("val-password").disabled = false;
        //         document.getElementById("val-password-repeat").disabled = false;
        //     } else {
        //         document.getElementById("val-username").disabled = true;
        //         document.getElementById("val-password").disabled = true;
        //         document.getElementById("val-password-repeat").disabled = true;
        ...
        $(document).on('input', '#berat_barang', function() {
            ...
            var harga_total = parseFloat(harga_paket_satuan) * parseFloat(int_berat_paket);
            var antar_harga = $('.antar_harga_kiloan_input').val();
            harga_kilo_input = harga_total;
            var harga_total_2 = parseFloat(harga_total) + parseFloat(antar_harga);
            $('.harga_paket_kiloan').html('Rp. ' + parseFloat(harga_total).toLocaleString());
            $('input[name=harga_paket_kiloan]').val(harga_total);
            $('.total_kiloan_rp').html('Rp. ' + parseFloat(harga_total_2).toLocaleString());
            $('input[name=total_kiloan_rp]').val(parseFloat(harga_total_2));
        });
        ...
        $(document).ready(function() {
            ...
            $(".registrasi-form").validate({
                ...
                messages: {
                    ...
                    berat_barang: {
                        required: "<span style='color: red;'>Silakan masukkan berat barang</span>",
                        min: function(param) {
                            return "<span style='color: red;'>Minimal kg " + param + "</span>";
                        }
                    },
