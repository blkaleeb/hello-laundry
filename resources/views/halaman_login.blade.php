                        ...
                        <div class="form-input-content">
                            <div class="card login-form mb-0">
                                <div class="card-body pt-5">
                                    ...
                                    <form method="POST" action="{{ url('/registrasi_awal') }}" class="mt-5 mb-5"
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input avatar-input"
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if ($message = Session::get('gagal_login'))
                                            <div class="alert alert-danger alert-dismissible fade show"
                                                ...
                                                </button> <strong>Peringatan!</strong> {{ $message }}
                                            </div>
                                        @endif
                                    </div>
                                    <form method="POST" action="{{ url('/login_verifikasi') }}"
                                        class="mt-5 mb-5 login-input" name="form_login">
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" name="username" class="form-control"
                                                placeholder="Username">
