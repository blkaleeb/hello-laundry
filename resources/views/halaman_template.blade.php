...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('icons/hello_icon.png') }}">
        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{ url('/dashboard') }}">
                    <div class="brand-title" style="font-size: 1.5rem; font-family: 'Poppins', sans-serif; color: #FFF">
                        Hello
                        Laundry</div>
                </a>
            </div>
            ...
            <div class="header-content clearfix">
                ...
                <div class="header-left">
                    <div class="input-group icons">
                        ...
                        <input type="search" class="form-control search_page_input" placeholder="Cari"
                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                <img src="{{ asset('/pictures/' . auth()->user()->avatar) }}" height="40"
                                    width="40" alt="">
                            </div>
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        @if (auth()->user()->role == 'admin' || auth()->user()->role == 'kasir')
                                            <li>
                                                <a href="{{ url('/kelola_profil') }}"><i class="icon-user"></i>
                                                    <span>Profil</span></a>
                                            </li>
                                            <hr class="my-2">
                                        @endif
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label font-weight-bold">Dashboard</li>
                    <li>
                    ...
                    @if (auth()->user()->role == 'admin')
                        <li class="nav-label font-weight-bold">Kelola Data</li>
                    ...
                    @endif
                    @if (auth()->user()->role == 'admin' || auth()->user()->role == 'kasir')
                        <li class="nav-label font-weight-bold">Layanan Laundry</li>
                        <li>
                            <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <li class="nav-label font-weight-bold">Laporan</li>
                        <li>
                            <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    ...
                    @if (auth()->user()->role == 'member' || auth()->user()->role == 'non_member')
                        ...
                        <li>
                            <a href="{{ url('/pesanan_saya') }}" aria-expanded="false">
                                <i class="fa fa-shopping-cart menu-icon"></i><span class="nav-text">Pesanan
                                    Saya</span>
                            </a>
                        </li>
                    @endif
            ...
            if ($(this).val() != '') {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('.judul_pencarian').html('' + response.length + ' Hasil Pencarian "' +
                            search_word + '"');
                        ...
                        for (var i = 0; i <= lengthLoop; i++) {
                            ...
                            searchResultList += '<a href="' + url +
                                '" class="list-group-item list-group-item-action flex-column align-items-start"><div class="d-flex w-100 justify-content-between"><h5 class="mb-1 text-primary">' +
                                response[i].page_name +
                                '</h5></div><div class="mb-1 page_url">http://localhost:8000/' +
                                response[i].page_url + '</div></a>';
                        }
